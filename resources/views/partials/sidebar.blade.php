            ...
            <div class="px-3 space-y-1">
                ...
                <div class="mb-6">
                    ...
                    <div class="space-y-1">
                        ...
                        <a href="{{ route('tenant.reports.shift-logs', $tenant->slug) }}" 
                           class="sidebar-item group"
                           :class="{ 'sidebar-item-active': isActiveRoute('{{ '/'.$tenant->slug.'/reports/shift-logs' }}') }"
                           :title="isCollapsed ? 'Shift Logs' : ''">
                            <svg class="sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                            </svg>
                            <span x-show="!isCollapsed" class="sidebar-text">Shift Logs</span>
                        </a>
