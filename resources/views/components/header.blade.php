...
<header class="sticky top-0 z-50 bg-white/95 backdrop-blur border-b border-gray-200" x-data="{ mobileMenuOpen: false }" x-init="console.log('Header initialized, mobileMenuOpen:', mobileMenuOpen)" @click.away="mobileMenuOpen = false">
  <div class="mx-auto max-w-7xl px-4 py-4 flex items-center justify-between">
    ...
    {{-- Mobile Menu Button --}}
    <button @click="mobileMenuOpen = !mobileMenuOpen; console.log('Menu toggled, mobileMenuOpen:', mobileMenuOpen)" class="md:hidden p-2 rounded-md text-gray-600 hover:text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-orange-500">
  ...
  <div x-show="mobileMenuOpen" 
       ...
       class="md:hidden"
       x-cloak>
    <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-gray-200" @click="mobileMenuOpen = false">
