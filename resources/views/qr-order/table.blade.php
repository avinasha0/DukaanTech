...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title>{{ $account->name }} - Table {{ $tableNo }}</title>
    <meta name="description" content="Order from Table {{ $tableNo }} at {{ $account->name }}. Browse our menu, place your order, and enjoy our delicious food with contactless QR code ordering.">
    <meta name="keywords" content="table ordering, QR code ordering, restaurant table, contactless ordering, {{ $account->name }}, table {{ $tableNo }}, food ordering, digital menu">
    <meta name="author" content="{{ $account->name }}">
    <meta name="robots" content="index, follow">
    <meta name="language" content="English">
    
    <!-- Open Graph Meta Tags -->
    <meta property="og:title" content="{{ $account->name }} - Table {{ $tableNo }}">
    <meta property="og:description" content="Order from Table {{ $tableNo }} at {{ $account->name }}. Browse our menu, place your order, and enjoy our delicious food with contactless QR code ordering.">
    ...
    <meta name="twitter:title" content="{{ $account->name }} - Table {{ $tableNo }}">
    <meta name="twitter:description" content="Order from Table {{ $tableNo }} at {{ $account->name }}. Browse our menu, place your order, and enjoy our delicious food with contactless QR code ordering.">
    @if(isset($account->logo_url) && $account->logo_url)
    ...
    <meta name="application-name" content="{{ $account->name }} Table {{ $tableNo }}">
    <meta name="apple-mobile-web-app-title" content="Table {{ $tableNo }}">
...
<body class="bg-gray-50">
    <div class="min-h-screen">
        ...
        <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-8">
                <h2 class="text-xl font-semibold text-gray-900 mb-4">Place Your Order - Table {{ $tableNo }}</h2>
                
                <form id="orderForm" class="space-y-4">
                    <input type="hidden" name="table_no" value="{{ $tableNo }}">
                    <input type="hidden" name="mode" value="DINE_IN">
    ...
    <script>
        ...
        async function placeOrder() {
            ...
            if (!orderData.outlet_id || !orderData.order_type_id || !orderData.payment_method) {
