...
<head>
    ...
    <title>Create Role - {{ $tenant->name }} - Dukaantech POS</title>
        ...
        <div class="mx-auto max-w-4xl px-4">
            ...
            <div class="mb-6 lg:mb-8">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl lg:text-3xl font-bold text-gray-900 mb-2 font-dm">Create New Role</h1>
                        <p class="text-sm lg:text-base text-gray-600">Define a new role and assign permissions</p>
                    </div>
            ...
            <div class="bg-white shadow-xl rounded-2xl overflow-hidden border border-gray-100">
                <form method="POST" action="{{ route('tenant.roles.store', ['tenant' => $tenant->slug]) }}">
                    @csrf
                    <div class="px-6 py-8">
                        {{-- Role Information --}}
                        <div class="grid grid-cols-1 gap-6 mb-8">
                            <div>
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name') }}" 
                                       class="w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-orange-500 focus:border-orange-500 @error('name') border-red-300 @enderror" 
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description" rows="3" 
                                          class="w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-orange-500 focus:border-orange-500 @error('description') border-red-300 @enderror"
                        ...
                        <div>
                            ...
                            @foreach($permissions as $module => $modulePermissions)
                                <div class="mb-8">
                                    <h4 class="text-lg font-semibold text-gray-800 mb-4 capitalize flex items-center">
